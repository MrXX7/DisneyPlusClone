...
private func getTabIcons(geo: GeometryProxy) -> some View {
    ...
    return HStack {
        ...
        TabBarIcon(tabViewRouter: tabViewRouter, currentPage: .home, width: width, height: height, systemIconName: "magnifyingglass", tabName: "Search")
        
        TabBarIcon(tabViewRouter: tabViewRouter, currentPage: .home, width: width, height: height, systemIconName: "square.and.arrow.down.fill", tabName: "Downloads")
        
        TabBarIcon(tabViewRouter: tabViewRouter, currentPage: .home, width: width, height: height, systemIconName: "person.circle", tabName: "Profile")
    }
